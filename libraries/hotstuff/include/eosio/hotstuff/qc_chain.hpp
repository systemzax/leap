/*
  QC Chain - Quorum Certificate Chain

  The qc_chain class models the core in-memory Hotstuff algorithm state for
  any participant peer (e.g. proposer/leader or validator/voter) in a Hotstuff
  consensus network.
*/
